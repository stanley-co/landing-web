...
| AD-003 | w-admin-web | Implement category and product editors with media, specs, advantages, gallery, video, relations, archive/reorder | AD-002, CA-005, ST-002 | IN_PROGRESS | `ec68b8a` adds authenticated category tree/create/archive and product list/search/status/archive; full product editor remains. No raw JSON editor. |
