...
| CA-003 | w-backend-service | Add ordered specs, advantages, gallery, main media, video, and related content | CA-002, ST-001 | IN_PROGRESS | V9 relation schema and product-media safe-delete guard implemented; next: aggregate write/read model and validation. |
