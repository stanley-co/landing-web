...
| AD-003 | w-admin-web | Implement category and product editors with media, specs, advantages, gallery, video, relations, archive/reorder | AD-002, CA-005, ST-002 | IN_PROGRESS | `ec68b8a` adds category/product lists; `35b0294` adds typed product create/update fields and image/gallery selectors. Content picker/reorder UX and UI coverage remain. No raw JSON editor. |
